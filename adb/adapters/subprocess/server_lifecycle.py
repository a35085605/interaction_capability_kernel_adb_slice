...
# Compatibility aliases for code/tests that reached into the previous private adapter types.
_AdbServerSubprocessFactory = AospAdbServerProcessDriver
_AdbServerSubprocessResource = AospAdbServerProcessResource
_AdbServerSubprocessStartError = AospAdbServerStartError
_AdbServerSubprocessTerminationUnconfirmed = AospAdbServerTerminationUnconfirmed
_OwnedAdbServerProcess = AospOwnedAdbServerProcess
...
class SubprocessAdbServerLifecycle(AdbServerLifecycleCoordinator[Any]):
    ...
    def __init__(
        ...
        *,
        ...
        if _factory is None:
            if os.name == "nt":
                from adb.aosp.io.server_process_windows import (
